...
angular.module('MainApp', ['ngAnimate', 'ngAria', 'ngMaterial', 'ngMessages', 'app.config', 'app.directives'])
    .controller('MainController', function ($scope, $mdToast, $window) {
        $window.addEventListener('offline', function () {
            $mdToast.show({
                hideDelay: 3000,
                position: 'bottom left',
                controller: 'OfflineToastCtrl',
                template:
                '<md-toast>' +
    ...
    .controller('OfflineToastCtrl', function ($scope) {
        /**
         * Closes the toast
         */
...
angular.module('MediaApp', ['ngAnimate', 'ngAria', 'ngMaterial', 'ngMessages', 'app.config', 'app.directives'])
    .controller('SocialController', function ($scope) {
        $scope.social = [
            ...
            { name: 'Reddit', url: 'https://reddit.com/Chan4077' }
        ];
    });
