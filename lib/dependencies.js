...
angular.module('app.directives', [])
	...
	.directive('siteSidenav', () => {
		var SidenavController = ($scope, $mdSidenav) => {
			...
			$scope.main = [
				...
				{ url: '/instagram', title: 'Instagram Links', icon: 'instagram'}
			];
			$scope.beta = [
			...
			$scope.projects = [
				...
				{ url: 'https://studybuddy-e5f46.firebaseapp.com', title: 'StudyBuddy', desc: "A study buddy compatible with Android Oreo." },
	...
	.directive('siteToolbar', () => {
		var ToolbarController = ($scope, $mdDialog, $mdToast, $mdSidenav) => {
...
angular.module('app.config', [])
	.config(($mdIconProvider, $interpolateProvider, $sceDelegateProvider) => {
		...
		$mdIconProvider
			.defaultIconSet('https://chan4077.github.io/res/mdi.svg')
