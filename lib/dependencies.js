...
angular.module('app.directives', [])
    .directive('networkToast', function () {
        ...
        var NetworkToastCtrl = function ($scope, $mdToast, $window) {
            ...
            $window.addEventListener('load', function() {
                $mdToast.show({
					// Make it so that it will never hide
                    hideDelay: 0,
					...
					'<span class="md-toast-text" flex>Unfortunately, this site will be depreceated soon.</span>' +
					'<md-button href="https://githubpageschan4077.firebaseapp.com">'+
					'Go to new website'+
					'</md-button>'+
					'<md-button href="https://github.com/Chan4077/chan4077.github.io/issues/34" target="_blank">' +
					'Learn More' +
					'</md-button>' +
                    '</div>' +
                    '</md-toast>'
            ...
            $window.addEventListener('offline', function () {
                $mdToast.show({
                    ...
                    '<md-button ng-click="tryAgain()" class="md-highlight">'+
                    'Try Again'+
                    '</md-button>'+
    ...
    .directive('siteSidenav', function () {
        var SidenavController = function ($scope, $mdSidenav) {
            ...
            $scope.projects = [
                { url: '/projects', title: 'Projects', icon: 'code-tags' },
                { url: '/MyFirstApp', title: 'MyFirstApp', icon: 'code-tags' },
                { url: '/icons', title: 'Icons', icon: 'code-tags' }
            ];
            // Toggle left sidenav
