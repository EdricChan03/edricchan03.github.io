...
@-webkit-keyframes mdc-checkbox-fade-in-background-u019c3b {
  0% {
    border-color: rgba(0, 0, 0, 0.54);
    background-color: transparent;
  }
...
@keyframes mdc-checkbox-fade-in-background-u019c3b {
  0% {
    border-color: rgba(0, 0, 0, 0.54);
    background-color: transparent;
  }
...
@-webkit-keyframes mdc-checkbox-fade-out-background-u019c3b {
  0%, 80% {
    border-color: #018786;
    /* @alternate */
    border-color: var(--mdc-theme-secondary, #018786);
...
@keyframes mdc-checkbox-fade-out-background-u019c3b {
  0%, 80% {
    border-color: #018786;
    /* @alternate */
    border-color: var(--mdc-theme-secondary, #018786);
...
.mdc-checkbox--anim-unchecked-checked .mdc-checkbox__native-control:enabled ~ .mdc-checkbox__background, .mdc-checkbox--anim-unchecked-indeterminate .mdc-checkbox__native-control:enabled ~ .mdc-checkbox__background {
  -webkit-animation-name: mdc-checkbox-fade-in-background-u019c3b;
          animation-name: mdc-checkbox-fade-in-background-u019c3b;
}
.mdc-checkbox--anim-checked-unchecked .mdc-checkbox__native-control:enabled ~ .mdc-checkbox__background, .mdc-checkbox--anim-indeterminate-unchecked .mdc-checkbox__native-control:enabled ~ .mdc-checkbox__background {
  -webkit-animation-name: mdc-checkbox-fade-out-background-u019c3b;
          animation-name: mdc-checkbox-fade-out-background-u019c3b;
}
