...
<html lang="en"><head>
  ...
  <link rel="canonical" href="https://chan4077.github.io/node_modules/@material/dom/">
...
<link rel="canonical" href="https://chan4077.github.io/node_modules/@material/dom/" />
<meta property="og:url" content="https://chan4077.github.io/node_modules/@material/dom/" />
<meta property="og:site_name" content="Chan4077.GitHub.io" />
<script type="application/ld+json">
{"description":"My personal Github pages website.","@type":"WebPage","headline":"Chan4077.GitHub.io","url":"https://chan4077.github.io/node_modules/@material/dom/","@context":"http://schema.org"}</script>
<!-- End Jekyll SEO tag -->
...
<p>MDC DOM provides commonly-used utilities for inspecting, traversing, and manipulating the DOM.</p>

<p>Most of the time, you shouldn’t need to depend on <code class="highlighter-rouge">mdc-dom</code> directly. It is useful however if you’d like to write custom components that follow MDC Web’s pattern and elegantly integrate with the MDC Web ecosystem.</p>

<h2 id="installation">Installation</h2>

<div class="highlighter-rouge"><div class="highlight"><pre class="highlight"><code>npm install @material/dom
</code></pre></div></div>

<h2 id="basic-usage">Basic Usage</h2>

<div class="language-js highlighter-rouge"><div class="highlight"><pre class="highlight"><code><span class="k">import</span> <span class="o">*</span> <span class="k">as</span> <span class="nx">ponyfill</span> <span class="k">from</span> <span class="s1">'@material/dom/ponyfill'</span><span class="p">;</span>
</code></pre></div></div>
...
<h2 id="ponyfill-functions">Ponyfill Functions</h2>

<p>The <code class="highlighter-rouge">ponyfill</code> module provides the following functions:</p>
...
<table>
  ...
  <tbody>
    <tr>
      <td><code class="highlighter-rouge">closest(element: Element, selector: string) =&gt; ?Element</code></td>
      <td>Returns the ancestor of the given element matching the given selector (which may be the element itself if it matches), or <code class="highlighter-rouge">null</code> if no matching ancestor is found.</td>
    </tr>
    <tr>
      <td><code class="highlighter-rouge">matches(element: Element, selector: string) =&gt; boolean</code></td>
      <td>Returns true if the given element matches the given CSS selector.</td>
    </tr>
  </tbody>
</table>
