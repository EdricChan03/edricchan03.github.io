...
@-webkit-keyframes mdc-checkbox-fade-in-background-u019c3w {
  0% {
    border-color: rgba(0, 0, 0, 0.54);
    background-color: transparent;
  }
...
@keyframes mdc-checkbox-fade-in-background-u019c3w {
  0% {
    border-color: rgba(0, 0, 0, 0.54);
    background-color: transparent;
  }
...
@-webkit-keyframes mdc-checkbox-fade-out-background-u019c3w {
  0%, 80% {
    border-color: #6200ee;
    /* @alternate */
    border-color: var(--mdc-theme-primary, #6200ee);
...
@keyframes mdc-checkbox-fade-out-background-u019c3w {
  0%, 80% {
    border-color: #6200ee;
    /* @alternate */
    border-color: var(--mdc-theme-primary, #6200ee);
...
.mdc-data-table__row-checkbox.mdc-checkbox--anim-unchecked-indeterminate .mdc-checkbox__native-control:enabled ~ .mdc-checkbox__background {
  -webkit-animation-name: mdc-checkbox-fade-in-background-u019c3w;
          animation-name: mdc-checkbox-fade-in-background-u019c3w;
}
.mdc-data-table__header-row-checkbox.mdc-checkbox--anim-checked-unchecked .mdc-checkbox__native-control:enabled ~ .mdc-checkbox__background, .mdc-data-table__header-row-checkbox.mdc-checkbox--anim-indeterminate-unchecked .mdc-checkbox__native-control:enabled ~ .mdc-checkbox__background,
.mdc-data-table__row-checkbox.mdc-checkbox--anim-checked-unchecked .mdc-checkbox__native-control:enabled ~ .mdc-checkbox__background,
.mdc-data-table__row-checkbox.mdc-checkbox--anim-indeterminate-unchecked .mdc-checkbox__native-control:enabled ~ .mdc-checkbox__background {
  -webkit-animation-name: mdc-checkbox-fade-out-background-u019c3w;
          animation-name: mdc-checkbox-fade-out-background-u019c3w;
}
